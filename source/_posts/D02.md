...
tags: D02
---
##Open-Estuary Opensource Board D02 hacking manual
...
6.<span id="sourcecode">Source Code</span>: you can get all source code mentioned above according to the README file in following repository:
	...
	https://github.com/open-estuary/estuary
...
1.Clone the latest kernel source code with following command 
    ...
    git clone https://github.com/open-estuary/kernel.git -b estuary
...
```
   ...
   make defconfig
   make -j16
   make ./open-estuary/hip05-d02.dtb
```
Or you can also directly do build.sh in kernel tree directory.
Then there are two files that have been created:Image in the directory **arch/arm64/boot/**, and hip05-d02.dtb in the directory **arch/arm64/boot/dts/open-estuary**
...
2.Relative files are placed as follow:
        ...
        sda1: -------EFI
              ...
              |
              |-------------Image_3.1           //kernel Image file
              |
              |-------------hip05-d02_3.16      //kernel device tree binary
              |
              |-------------Image_3.19
              |
              |-------------hip05-d02_3.19
